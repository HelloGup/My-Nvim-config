...
function M.setup()
  ...
  theme.highlights = {
    ...
    CursorLine = { bg = c.none },--当前行高亮 -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    FloatBorder = { fg = c.border_highlight, bg = c.none },
    Pmenu = { bg = c.none, fg = c.fg }, -- Popup menu: normal item.
    ...
    PmenuThumb = { bg = c.fg_gutter },--滑块 -- Popup menu: Thumb of the scrollbar.
    Question = { fg = c.blue }, -- |hit-enter| prompt and yes/no questions
    QuickFixLine = { bg = c.bg_visual, bold = true }, -- Current |quickfix| item in the quickfix window. Combined with |hl-CursorLine| when the cursor is there.
    Search = { bg = c.none, fg = c.fg }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    ...
    StatusLine = { fg = c.fg_sidebar, bg = c.none }, -- status line of current window
    StatusLineNC = { fg = c.fg_gutter, bg = c.none }, -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    TabLine = { bg = c.none, fg = c.fg_gutter }, -- tab pages line, not active tab page label
    ...
    mkdCodeDelimiter = { bg = c.none, fg = c.fg },
    ...
    debugPC = { bg = c.none }, -- used for highlighting the current line in terminal-debug
    ...
    -- Telescope
    TelescopeBorder = { fg = c.border_highlight, bg = c.none },
    ...
    NvimTreeNormalNC = { fg = c.fg_sidebar, bg = c.none },
    NvimTreeRootFolder = { fg = c.blue, bold = true },
    NvimTreeGitDirty = { fg = c.git.change },
    NvimTreeGitNew = { fg = c.git.add },
    NvimTreeGitDeleted = { fg = c.git.delete },
    NvimTreeOpenedFile = { bg = c.none },
    ...
    NeoTreeNormal = { fg = c.fg_sidebar, bg = c.none },
    NeoTreeNormalNC = { fg = c.fg_sidebar, bg = c.none },
